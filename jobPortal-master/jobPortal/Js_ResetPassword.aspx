<%@ Page Title="" Language="C#" MasterPageFile="~/Js_userMaster.Master" AutoEventWireup="true" CodeBehind="Js_ResetPassword.aspx.cs" Inherits="jobPortal.Js_ResestPassword" %>
    ...
    <form name="_ctl0" method="post" id="_ctl0" runat="server">
        ...
        <div class="col-md-8">
            ...
            <div class="form-group">
               ...
               <div class="row">
                    <div class="col-xs-8">
                        <a href="Js_Login.aspx">Click Here to Login</a>
                    </div>
