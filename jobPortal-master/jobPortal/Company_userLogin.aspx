<%@ Page Title="" Language="C#" MasterPageFile="~/CompanyMaster.Master" AutoEventWireup="true" CodeBehind="Company_userLogin.aspx.cs" Inherits="jobPortal.Company_userLogin" %>
        ...
        <div class="register-box">
            ...
            <div class="register-box-body">
                <div class="form-group has-feedback">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" class="help-block" ErrorMessage="Enter User Id" ControlToValidate="txtId"></asp:RequiredFieldValidator>
                ...
                <div class="row">
                    <div class="col-xs-8">
                       <a href="Company_ForgotPassword.aspx?cmd=comp_user"">Forgot password</a>
                    </div>
                    <div class="col-xs-4">
